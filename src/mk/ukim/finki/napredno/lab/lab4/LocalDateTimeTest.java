package mk.ukim.finki.napredno.lab.lab4;
...
public class LocalDateTimeTest {
    ...
    static LocalDateTime localDateTimeOf() {
         ...
         */
        LocalDateTime ltdc = LocalDateTime.of(2015,06,20,23,07,30);
        return ltdc;
    }

    static LocalDateTime localDateTimeParse() {
        /**
         * Create a {@link LocalDateTime} of 2015-06-20 23:07:30 by
         * using {@link LocalDateTime#parse}
         */

        String time = "2015-06-20 23:07:30";
        DateTimeFormatter custom = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
        LocalDateTime ldt = LocalDateTime.parse(time,custom);
        return ldt;
    }
    ...
    static LocalDateTime localTimeWith() {
         ...
         */
        LocalDateTime ldt2 = ldt.with(TemporalAdjusters.firstDayOfNextMonth());
        return ldt2.truncatedTo(ChronoUnit.HOURS);
    }
    ...
    static LocalDateTime localDatePlusMinus() {
         ...
         */
        LocalDateTime v2 = ldt.minusHours(5).plusMonths(10);
        return v2;
    }
