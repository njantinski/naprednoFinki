...
public class ZonedDateTimeTest {
    ...
    static ZonedDateTime zonedDateTimeParse() {
         ...
         */
        ZonedDateTime zdt = ZonedDateTime.parse("2015-06-18T23:07:25.000[Asia/Tokyo]");
        return zdt;
    }
    ...
    static String zonedDateTimeFormat() {
        ...
        String toReturnTime = zdt.format(DateTimeFormatter.ofPattern("yyyy_MM_dd_HH_mm_ss_z"));
        return toReturnTime;
    }
    ...
    static ZonedDateTime toPST() {
        ...
        ZonedDateTime pacific = ldt.atZone(ZoneId.of("America/Los_Angeles"));
        return pacific;
    }
